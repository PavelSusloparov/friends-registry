import { BudgetVariables, createFriendVariables, GetFriends, GetOneFriend } from "../../../generated/graphql/generatedTypes";
import { GraphqlClient } from "../../../utils/graphql/client";
import { createFriend } from "./queries/CreateFriend";
...
export const getOneFriend = (input: BudgetVariables, client: GraphqlClient) => {
    return client
        .query<GetOneFriend>({
            variables: {
                id: input.id
